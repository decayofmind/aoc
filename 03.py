            ...
            if direction == 'U':
                for i in range(length):
                    ...
                    if c:
                        ...
                        field[cell_key] = Cell(start[0], start[1]+i, content=[self.name], steps_made=[steps])
                start[1] += length
            if direction == 'D':
                for i in range(length):
                    steps += 1
            ...
            if direction == 'R':
                for i in range(length):
                    ...
                    if c:
                        ...
                        field[cell_key] = Cell(start[0]+i, start[1], content=[self.name], steps_made=[steps])
                start[0] += length
            if direction == 'L':
                for i in range(length):
                    steps += 1
...
for key, cell in field.items():
    if len(cell.content) == 2 and len(set(cell.content)) > 1 and cell.x != 0 and cell.y != 0:
